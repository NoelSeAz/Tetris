...
public class JSquare extends Figure {
    public JSquare(){
        super(Constants.J_Quare, EnumFigure.J_SQUARE);
    ...
    public LinkedList<Square> rotateElement(Square[][] board){
        ...
        switch(this.getPosition()) {
            case UP:
                ...
                squares.add(currentSQ.clone().setLocation(currentSQ.getIndexI() + 1, currentSQ.getIndexJ(), Constants.BOARD_X, Constants.BOARD_Y));
                currentSQ = this.getSquares().get(1);
                squares.add(currentSQ.clone().setLocation(currentSQ.getIndexI() + 2 , currentSQ.getIndexJ() -1, Constants.BOARD_X, Constants.BOARD_Y));
                currentSQ = this.getSquares().get(2);
                squares.add(this.getSquares().get(2).clone());
            ...
            case DOWN:
                ...
                squares.add(currentSQ.clone().setLocation(currentSQ.getIndexI() + 1, currentSQ.getIndexJ(), Constants.BOARD_X, Constants.BOARD_Y));
                currentSQ = this.getSquares().get(1);
                squares.add(currentSQ.clone().setLocation(currentSQ.getIndexI(), currentSQ.getIndexJ()+1, Constants.BOARD_X, Constants.BOARD_Y));
                currentSQ = this.getSquares().get(2);
