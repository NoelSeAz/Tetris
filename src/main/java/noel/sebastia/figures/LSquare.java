...
public class LSquare extends Figure {
    public LSquare(){
        super(Constants.L_Quare, EnumFigure.L_SQUARE);
    ...
    public LinkedList<Square> rotateElement(Square[][] board){
        ...
        switch(this.getPosition()) {
            ...
            case RIGHT:
                ...
                squares.add(currentSQ.clone().setLocation(currentSQ.getIndexI() + 1, currentSQ.getIndexJ() - 1, Constants.BOARD_X, Constants.BOARD_Y));
                currentSQ = this.getSquares().get(3);
                squares.add(currentSQ.clone().setLocation(currentSQ.getIndexI() - 2, currentSQ.getIndexJ(), Constants.BOARD_X, Constants.BOARD_Y));
                break;
            case DOWN:
                currentSQ = this.getSquares().get(0);
                squares.add(currentSQ.clone().setLocation(currentSQ.getIndexI(), currentSQ.getIndexJ() - 1, Constants.BOARD_X, Constants.BOARD_Y));
